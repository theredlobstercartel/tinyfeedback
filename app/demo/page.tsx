  ...
  return (
    <div className="min-h-screen p-8" style={{ backgroundColor: '#000000' }}>
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="flex items-center justify-between">
          <div className="space-y-4">
            ...
            <p style={{ color: '#888888' }}>
              See how the feedback widget and dashboard work
            </p>
          </div>
          <a
            href="/"
        ...
        >
          <h3 className="mb-2" style={{ color: '#ffffff' }}>Features Demo:</h3>
          <ul className="space-y-1 list-disc list-inside">
            <li>✅ Feedback detail view with internal notes</li>
            <li>✅ Status management and workflow</li>
