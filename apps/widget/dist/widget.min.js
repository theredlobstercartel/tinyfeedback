...
"use strict";var TinyFeedback=(()=>{var k=Object.defineProperty;var W=Object.getOwnPropertyDescriptor;var z=Object.getOwnPropertyNames;var $=Object.prototype.hasOwnProperty;var F=(r,t)=>{for(var e in t)k(r,e,{get:t[e],enumerable:!0})},H=(r,t,e,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let a of z(t))!$.call(r,a)&&a!==e&&k(r,a,{get:()=>t[a],enumerable:!(n=W(t,a))||n.enumerable});return r};var B=r=>H(k({},"__esModule",{value:!0}),r);var Y={};F(Y,{default:()=>O,defaultConfig:()=>p,defaultThemes:()=>m,generateCSSVariables:()=>v,getMergedColors:()=>h});var q={primary:"#00e5ff",secondary:"#ff4ecd",background:"#0a0a0a",surface:"#141414",text:"#ffffff",textMuted:"#b0b0b0",border:"#00e5ff33",success:"#00d084",error:"#ff5252",warning:"#ffb347"},P={primary:"#0052cc",secondary:"#403294",background:"#ffffff",surface:"#f5f5f5",text:"#1a1a1a",textMuted:"#595959",border:"#d0d0d0",success:"#006600",error:"#cc0000",warning:"#b35900"},I={primary:"#66b3ff",secondary:"#a5b4fc",background:"#0f172a",surface:"#1e293b",text:"#f8fafc",textMuted:"#94a3b8",border:"#475569",success:"#4ade80",error:"#f87171",warning:"#fbbf24"},m={"cyber-neon":q,minimal:P,dark:I},p={theme:"cyber-neon",position:"bottom-right",colors:{},labels:{nps:"Como voc\xEA avalia nosso produto?",suggestion:"Sugest\xE3o",bug:"Reportar um problema",submit:"Enviar",cancel:"Cancelar",close:"Fechar"},categories:["Feature","Improvement","Other"]};function h(r,t={}){return{...m[r],...t}}function v(r){return{"--tf-primary":r.primary,"--tf-secondary":r.secondary||r.primary,"--tf-background":r.background,"--tf-surface":r.surface,"--tf-text":r.text,"--tf-text-muted":r.textMuted,"--tf-border":r.border,"--tf-success":r.success,"--tf-error":r.error,"--tf-warning":r.warning}}function j(){return`
  ...
  `}function S(r,t){let e=v(r),n=D(t);return`
    :host {
      ${Object.entries(e).map(([a,o])=>`${a}: ${o};`).join(`
      `)}
      --tf-z-index: 9999;
    ...
    ${j()}
  `}function D(r){return{"bottom-right":"bottom: 20px; right: 20px;","bottom-left":"bottom: 20px; left: 20px;","top-right":"top: 20px; right: 20px;","top-left":"top: 20px; left: 20px;"}[r]}function N(r){return{"bottom-right":"bottom: 16px; right: 16px;","bottom-left":"bottom: 16px; left: 16px;","top-right":"top: 16px; right: 16px;","top-left":"top: 16px; left: 16px;"}[r]}function C(r,t){let e=new CSSStyleSheet;e.replaceSync(r),t.adoptedStyleSheets=[e]}var b={message:`
  ...
  `},E=class{constructor(){this.config={...p};this.container=null;this.shadowRoot=null;this.isOpen=!1;this.currentTab="nps";this.apiKey="";this.previousFocus=null;this.focusableElements=[];this.announcer=null;this.keydownHandler=null;if(typeof document<"u"){let t=document.currentScript;if(t){this.apiKey=t.dataset.tfApikey||"";let e=t.dataset.tfPosition,n=t.dataset.tfTheme;e&&(this.config.position=e),n&&(this.config.theme=n)}}}init(t={}){typeof document>"u"||(this.config={...p,...this.config,...t,labels:{...p.labels,...t.labels},colors:{...this.config.colors,...t.colors}},this.render())}render(){this.destroy(),this.container=document.createElement("div"),this.container.id="tinyfeedback-widget",this.container.setAttribute("role","complementary"),this.container.setAttribute("aria-label","Widget de feedback"),this.shadowRoot=this.container.attachShadow({mode:"open"});let t=h(this.config.theme,this.config.colors),e=S(t,this.config.position);C(e,this.shadowRoot),this.shadowRoot.innerHTML=`
        ...
        >
          ...
          <div class="tf-tabs" role="tablist" aria-label="Tipo de feedback">
            <button 
              ...
              type="button"
            >
              <span class="tf-tab-icon" aria-hidden="true">${b.nps}</span>
              <span>NPS</span>
            </button>
            <button 
              class="tf-tab" 
              ...
              type="button"
            >
              <span class="tf-tab-icon" aria-hidden="true">${b.suggestion}</span>
            ...
            <button 
              ...
              type="button"
            >
              <span class="tf-tab-icon" aria-hidden="true">${b.bug}</span>
    ...
    `}attachEventListeners(){if(!this.shadowRoot)return;this.shadowRoot.getElementById("tf-trigger")?.addEventListener("click",()=>this.open()),this.shadowRoot.getElementById("tf-skip-link")?.addEventListener("click",i=>{i.preventDefault(),this.open()}),this.shadowRoot.getElementById("tf-close")?.addEventListener("click",()=>this.close());let a=this.shadowRoot.getElementById("tf-modal-overlay");a?.addEventListener("click",i=>{i.target===a&&this.close()});let o=this.shadowRoot.querySelectorAll(".tf-tab");o.forEach(i=>{i.addEventListener("click",()=>{let s=i.getAttribute("data-tab");this.switchTab(s)})}),this.shadowRoot.querySelectorAll('[id^="tf-cancel-"]').forEach(i=>{i.addEventListener("click",()=>this.close())});let y=this.shadowRoot.querySelectorAll(".tf-nps-button");y.forEach(i=>{i.addEventListener("click",()=>{y.forEach(s=>{s.classList.remove("tf-selected"),s.setAttribute("aria-checked","false")}),i.classList.add("tf-selected"),i.setAttribute("aria-checked","true"),this.announce(`Nota ${i.getAttribute("data-score")} selecionada`)}),i.addEventListener("keydown",s=>{let f=Array.from(y),d=f.indexOf(s.target),l=d;switch(s.key){case"ArrowLeft":case"ArrowUp":s.preventDefault(),l=d>0?d-1:f.length-1;break;case"ArrowRight":case"ArrowDown":s.preventDefault(),l=d<f.length-1?d+1:0;break;case"Home":s.preventDefault(),l=0;break;case"End":s.preventDefault(),l=f.length-1;break}l!==d&&(f.forEach((g,w)=>{g.setAttribute("tabindex",w===l?"0":"-1")}),f[l].focus())})}),this.setupCharCounters(),this.setupFormSubmissions(),this.keydownHandler=i=>{i.key==="Escape"&&this.isOpen&&this.close(),i.key==="Tab"&&this.isOpen&&this.handleTabKey(i)},document.addEventListener("keydown",this.keydownHandler),o.forEach(i=>{i.addEventListener("keydown",s=>{let f=Array.from(o),d=f.indexOf(s.target),l=d;switch(s.key){case"ArrowLeft":s.preventDefault(),l=d>0?d-1:f.length-1;break;case"ArrowRight":s.preventDefault(),l=d<f.length-1?d+1:0;break;case"Home":s.preventDefault(),l=0;break;case"End":s.preventDefault(),l=f.length-1;break}if(l!==d){let g=f[l],w=g.getAttribute("data-tab");this.switchTab(w),g.focus()}})})}handleTabKey(t){if(!this.shadowRoot)return;let e=this.getFocusableElements();if(e.length===0)return;let n=e[0],a=e[e.length-1],o=this.shadowRoot.activeElement;t.shiftKey?(o===n||!e.includes(o))&&(t.preventDefault(),a.focus()):o===a&&(t.preventDefault(),n.focus())}getFocusableElements(){return this.shadowRoot?Array.from(this.shadowRoot.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])')).filter(n=>!n.hasAttribute("disabled")&&!n.hasAttribute("hidden")):[]}setupCharCounters(){if(!this.shadowRoot)return;this.shadowRoot.querySelectorAll(".tf-textarea, .tf-input").forEach(e=>{let n=e,a=n.parentElement?.querySelector(".tf-char-count");if(!a)return;let o=parseInt(n.getAttribute("maxlength")||"0",10);o&&(n.addEventListener("input",()=>{let c=n.value.length;a.textContent=`${c} / ${o}`,a.classList.remove("tf-warning","tf-error"),c>=o?a.classList.add("tf-error"):c>=o*.9&&a.classList.add("tf-warning")}),n.addEventListener("blur",()=>{n.value.length>=o&&this.announce(`Limite de ${o} caracteres atingido`)}))})}setupFormSubmissions(){if(!this.shadowRoot)return;this.shadowRoot.getElementById("tf-form-nps")?.addEventListener("submit",async a=>{if(a.preventDefault(),!this.shadowRoot?.querySelector(".tf-nps-button.tf-selected")){this.announce("Por favor, selecione uma nota de 0 a 10"),this.showError("Por favor, selecione uma nota de 0 a 10");return}this.showSuccess("Obrigado pelo seu feedback!")});let e=this.shadowRoot.getElementById("tf-form-suggestion");e?.addEventListener("submit",async a=>{if(a.preventDefault(),!e.checkValidity()){e.reportValidity();return}this.showSuccess("Sugest\xE3o enviada com sucesso!")});let n=this.shadowRoot.getElementById("tf-form-bug");n?.addEventListener("submit",async a=>{if(a.preventDefault(),!n.checkValidity()){n.reportValidity();return}this.showSuccess("Bug reportado com sucesso!")})}switchTab(t){if(!this.shadowRoot)return;this.currentTab=t,this.shadowRoot.querySelectorAll(".tf-tab").forEach(o=>{let c=o.getAttribute("data-tab")===t;o.classList.toggle("tf-active",c),o.setAttribute("aria-selected",String(c)),o.setAttribute("tabindex",c?"0":"-1")}),this.shadowRoot.querySelectorAll(".tf-tab-content").forEach(o=>{let c=o.getAttribute("data-tab-content")===t;o.classList.toggle("tf-active",c),c?o.removeAttribute("hidden"):o.setAttribute("hidden","")});let a={nps:"NPS",suggestion:"Sugest\xE3o",bug:"Reportar problema"};this.announce(`${a[t]} tab selecionada`),setTimeout(()=>{this.shadowRoot?.querySelector(`[data-tab-content="${t}"]`)?.querySelector("button, input, textarea, select")?.focus()},50)}announce(t){if(!this.shadowRoot)return;let e=this.shadowRoot.getElementById("tf-announcer");e&&(e.textContent=t,setTimeout(()=>{e.textContent=""},1e3))}showSuccess(t){if(!this.shadowRoot)return;this.announce(t);let e=this.shadowRoot.querySelector(".tf-tab-content.tf-active");e&&(e.innerHTML=`
      ...
      `),setTimeout(()=>this.close(),3e3)}showError(t){if(!this.shadowRoot)return;this.announce(`Erro: ${t}`);let e=this.shadowRoot.querySelector(".tf-form-error");e&&e.remove();let a=this.shadowRoot.querySelector(".tf-tab-content.tf-active")?.querySelector("form");if(a){let o=document.createElement("div");o.className="tf-error-message tf-form-error",o.setAttribute("role","alert"),o.setAttribute("aria-live","assertive"),o.textContent=t,a.insertBefore(o,a.firstChild)}}open(){if(!this.shadowRoot)return;this.previousFocus=document.activeElement;let t=this.shadowRoot.getElementById("tf-modal-overlay"),e=this.shadowRoot.getElementById("tf-modal"),n=this.shadowRoot.getElementById("tf-trigger");t?.classList.add("tf-open"),t?.setAttribute("aria-hidden","false"),n?.setAttribute("aria-expanded","true"),this.isOpen=!0,this.focusableElements=this.getFocusableElements(),setTimeout(()=>{this.shadowRoot?.getElementById("tf-modal-title")?.focus()},100)}close(){if(!this.shadowRoot)return;let t=this.shadowRoot.getElementById("tf-modal-overlay"),e=this.shadowRoot.getElementById("tf-trigger");t?.classList.remove("tf-open"),t?.setAttribute("aria-hidden","true"),e?.setAttribute("aria-expanded","false"),this.isOpen=!1,this.previousFocus&&this.previousFocus instanceof HTMLElement&&setTimeout(()=>{this.previousFocus?.focus()},0)}updateConfig(t){this.config={...this.config,...t,labels:{...this.config.labels,...t.labels},colors:{...this.config.colors,...t.colors}},this.render()}destroy(){this.keydownHandler&&(document.removeEventListener("keydown",this.keydownHandler),this.keydownHandler=null),this.container&&this.container.parentNode&&this.container.parentNode.removeChild(this.container),this.container=null,this.shadowRoot=null}},u=null;function x(r){return u||(u=new E),u.init(r),u}function T(){u?.destroy(),u=null}function M(){u?.open()}function L(){u?.close()}function R(r){u?.updateConfig(r)}typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>x()):x());var A={version:"1.0.0",init:x,destroy:T,open:M,close:L,updateConfig:R,themes:m};typeof window<"u"&&(window.TinyFeedback=A);var O=A;return B(Y);})();
